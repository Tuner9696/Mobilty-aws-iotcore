...
import inject
import paclientho.mqtt. as mqtt
import rospy
...
def _on_connect(client, userdata, flags, response_code):
    global bridge_params
    rospy.loginfo('MQTT connected rc='+hex(response_code))
    # configure bridges
    bridges = []
...
def _on_disconnect(client, userdata, response_code):
    rospy.loginfo('MQTT disconnected rc='+hex(response_code))
